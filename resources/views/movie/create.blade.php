    ...
    <main class="flex justify-center items-center min-w-screen min-h-screen">
        <div class="px-4 sm:px-12 pb-12 pt-7 mt-6 shadow-lg rounded-md bg-slate-800">
            ...
            <x-form route="movie.store" method="post" :files="true">
                        ...
                        <div class="flex items-center gap-2">
                            <div>
                                <input
                                    ...
                                    type="number" name="hours" value="{{old('hours') ?? 0}}" value="{{ old('hours') }}">
                            ...
                            <div class="flex items-center gap-2">
                                <input
                                    ...
                                    type="number" name="minutes" value="{{old('minutes') ?? 00}}" value="{{ old('minutes') }}">
                            </div>
                ...
                <div>
                    <select name="category_id" id="category" class="w-[50%] py-2 px-4 rounded-md text-base font-normal text-zinc-200 border border-slate-700 bg-slate-700/75 focus:shadow transition duration-150 outline-none @error('category_id') ring-1 ring-red-600 @endError">
